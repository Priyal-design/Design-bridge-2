...
import { features, customerLogos } from "../data";
    ...
    <div className="landing">
      ...
      <div className="landing-inner">
        <nav className="land-nav">
          <div className="brand">
            ...
            <div>
              ...
              <div className="brand-sub">by Jedi</div>
            </div>
          </div>
          <div className="links">
        ...
        <section className="hero-wrap">
          <div>
            <span className="hero-eyebrow">
              ...
              Design Memory for Modern Product Teams
            </span>
            <h1 className="hero-h1">
              Never lose <span className="grad">design knowledge</span> again.
            </h1>
            ...
            <div className="hero-cta">
              <Link to="/dashboard" className="btn btn-primary">
                Try Demo <span style={{ width: 16, height: 16 }}><IconArrow /></span>
              </Link>
        ...
        <section className="land-section" id="features">
          <h2>Everything your team's design memory needs</h2>
        ...
        {/* Customers */}
        <section className="land-section" id="customers">
          <h2>Trusted across Jedi teams</h2>
          <p className="sub">From finance to medical, every department builds on Design Bridge.</p>
          <div className="logos">
            {customerLogos.map((l) => (
        ...
        <section className="land-section" style={{ textAlign: "center", paddingBottom: 80 }}>
          <div className="glass-strong" style={{ padding: "56px 50px", borderRadius: "var(--radius-lg)" }}>
            ...
            <p className="sub" style={{ marginBottom: 28 }}>Explore the full demo experience — no signup required.</p>
