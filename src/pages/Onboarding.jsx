    ...
    <div className="page">
      <div className="onb-hero mb24">
        ...
        <div className="onb-hero-content">
          ...
          <p>
            You’re a Product Designer in Core Experiences, currently supporting the <Link to="/projects/fee-management" className="onb-hero-project-link">Fee Management System</Link> during validation. Your focus is the checkout experience, and Alex Kim is your primary design contact.
          </p>
        </div>
